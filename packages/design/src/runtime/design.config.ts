    ...
    accordion: {
      config: {
        ...
        rules: {
          ...
          '&__trigger':
            'rounded-[inherit] flex w-full items-center accordion-gap-item accordion-px-item accordion-py-item accordion-text-size-item accordion-text-item text-left font-medium outline-none cursor-pointer select-none accordion-transition',
    ...
    button: {
      config: {
        ...
        rules: {
          ...
          '&--primary.&--solid':
            'button-bg-primary-solid hover:button-bg-primary-solid-hover button-text-primary-solid',
          ...
          '&--neutral.&--solid':
            'button-bg-neutral-solid hover:button-bg-neutral-solid-hover button-text-neutral-solid',
          ...
          '&--warning.&--solid':
            'button-bg-warning-solid hover:button-bg-warning-solid-hover button-text-warning-solid',
          ...
          '&--success.&--solid':
            'button-bg-success-solid hover:button-bg-success-solid-hover button-text-success-solid',
