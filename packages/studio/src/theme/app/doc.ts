...
export const doc = defineComponent({
  ...
  rules: {
    ...
    '.doc-tokens__grid': `grid grid-cols-2 gap-4 sm:grid-cols-3 lg:grid-cols-3`,

    '.doc-token': `flex flex-col border border-default rounded-lg overflow-hidden`,
    '.doc-token__well': `h-16 flex items-center justify-center doc-bg-token-preview`,
    '.doc-token__meta': `flex flex-col gap-1 border-t border-default p-2`,
    '.doc-token__name': `font-mono text-xs text-foreground truncate`,
    '.doc-token__value': `font-mono text-xs text-muted truncate`,
    '.doc-token__bg': `size-sm rounded-md`,
    '.doc-token__text': `font-semibold leading-none`,
    '.doc-token__border': `size-sm rounded-md border-2`,
    '.doc-token__ring': `size-sm rounded-md doc-bg-shape outline-2 outline-offset-2`,
    '.doc-token__space': `flex items-center`,
    '.doc-token__shape': `size-sm rounded-sm doc-bg-shape`,
