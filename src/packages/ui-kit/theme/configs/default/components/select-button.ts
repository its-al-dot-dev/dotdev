...
export default defineSheet({
  ...
  utilities: {
    'px-sm': 'px-(--ui-space-sm)',
    'px-md': 'px-(--ui-space-md)',
    'px-lg': 'px-(--ui-space-lg)',
    'h-sm': 'h-(--ui-size-sm)',
    'h-md': 'h-(--ui-size-md)',
    'h-lg': 'h-(--ui-size-lg)',
    ...
    'size-sm': `text-(length:--ui-label-sm) select-button-h-sm`,
    'size-md': `text-(length:--ui-label-sm) select-button-h-md`,
    'size-lg': `text-(length:--ui-label-md) select-button-h-lg`,
