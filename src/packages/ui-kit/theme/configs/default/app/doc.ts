...
export default defineSheet({
  ...
  rules: {
    ...
    '&-tokens': `flex flex-col gap-6 scroll-mt-24 mt-12`,
    '&-tokens__header': `flex items-start gap-4`,
    '&-tokens__icon': `size-7.5 flex items-center justify-center border border-brand-soft bg-brand-soft text-brand text-base rounded-lg shrink-0`,
    '&-tokens__title': `font-semibold text-lg tracking-tight`,
    '&-tokens__desc': `text-sm text-muted mt-1`,
    '&-tokens__group': `flex flex-col gap-3 not-last:pb-6 not-last:border-b border-default`,
    '&-tokens__group-label': `font-mono text-xs uppercase tracking-wider text-muted`,
    '&-tokens__grid': `grid grid-cols-2 gap-3 sm:grid-cols-3 lg:grid-cols-4`,

    '&-token': `flex flex-col border border-default rounded-lg overflow-hidden`,
    '&-token__well': `h-16 flex items-center justify-center doc-bg-tint`,
    '&-token__well--end': `items-end pb-2`,
    '&-token__meta': `flex flex-col gap-0.5 border-t border-default p-2`,
    '&-token__name': `font-mono text-[11px] text-muted truncate`,
    '&-token__value': `font-mono text-xs text-foreground truncate`,
    '&-token__swatch': `size-9 rounded-md ring-1 ring-inset ring-black/10 dark:ring-white/10`,
    '&-token__shape': `inline-block size-2.5 rounded-sm bg-neutral`,
    '&-token__shape--rect': `h-8 w-12 bg-neutral`,
    '&-token__bar': `w-3 rounded-sm bg-neutral`,
    '&-token__label': `font-semibold leading-none`,
  },
})
